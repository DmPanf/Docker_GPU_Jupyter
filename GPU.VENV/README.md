Похоже, что на вашей системе Ubuntu 20.04.6 LTS не установлен Python 3.11. По умолчанию в Ubuntu 20.04 доступен Python 3.8. Чтобы использовать Python 3.10 или 3.11, вам необходимо установить его вручную.
